...
public class Interface
{
    ...
    public static void findTopPayingCustomers() throws SQLException
    {
        System.out.print
        (
        ...
        try {
            sql = 
                ...
                "FROM (SELECT sum(R.cost) as S, R.CID AS CID, RD.flight_number AS flight_number " +
                ...
                if (!res.next()) {
                    ...
                    System.out.println("Top-k customer for each airline.");
